...
namespace DDW_PDV_WPF
{
    ...
    public partial class frmVentanaPrincipal : Window
    {
        ...
        {
            //// Crear un objeto PrintDialog
            //PrintDialog printDialog = new PrintDialog();

            //// Mostrar el cuadro de diálogo de impresión
            //if (printDialog.ShowDialog() == true)
            //{
            //    // Establecer la impresora seleccionada y la configuración
            //    printDialog.PrintDocument(((IDocumentPaginatorSource)flowDoc).DocumentPaginator, "Ticket de compra");
            //}
